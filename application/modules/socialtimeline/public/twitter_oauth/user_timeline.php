...
/*$aTwitterinfos = json_decode($_GET['twitter_infos']);

$consumer_key = $aTwitterinfos->twitter_consumerkey;
$consumer_secret = $aTwitterinfos->twitter_consumersecret;
$oauth_access_token = $aTwitterinfos->twitter_accesstoken;
$oauth_access_token_secret = $aTwitterinfos->twitter_accesstokensecret;
*/

include_once('config.php');
$consumer_key = Pelican::$config['TWITTER_CONSUMER_KEY'] ;
$consumer_secret = Pelican::$config['TWITTER_CONSUMER_SECRET'];
$oauth_access_token = Pelican::$config['TWITTER_OAUTH_ACCESS_TOKEN'];
$oauth_access_token_secret = Pelican::$config['TWITTER_OAUTH_ACCESS_TOKEN_SECRET'];
