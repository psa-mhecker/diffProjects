...
class Portal_Page_User extends Pelican_Cache {
	...
	function getValue() {
		...
		/*
		if($this->params[1]){
		$sSQL.="INNER JOIN #pref#_portal_user_zone_template uzt on (uzt.PORTAL_USER_ID=:PORTAL_USER_ID and uzt.PAGE_ID=:PAGE_ID AND uzt.ZONE_TEMPLATE_ID=zt.ZONE_TEMPLATE_ID) ";
		}
		*/
