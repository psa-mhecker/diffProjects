            ...
            if (Pelican::$config['STICKYBAR'][$aBind[':TEMPLATE_PAGE_ID']]) {
                ...
                if ($aResults) {
                    if($aResults[0]['TEMPLATE_PAGE_ID']==Pelican::$config['TEMPLATE_PAGE']['SHOWROOM_ACCUEIL']
                                || $aResults[0]['TEMPLATE_PAGE_ID'] == Pelican::$config['TEMPLATE_PAGE']['MASTER_PAGE_STANDARD_N2']
                                || $aResults[0]['TEMPLATE_PAGE_ID'] == Pelican::$config['TEMPLATE_PAGE']['ACCUEIL_PROMOTION']){                        
                        $aResults[0]['PAGE_TITLE_BO'] = $aResults[0]['PAGE_GENERIQUE_LIBELLE'];
                        $aResults[0]['PAGE_TITLE'] = $aResults[0]['PAGE_GENERIQUE_LIBELLE'];       
                    }else{
