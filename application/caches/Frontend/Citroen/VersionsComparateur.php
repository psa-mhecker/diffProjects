...
class Frontend_Citroen_VersionsComparateur extends Pelican_Cache {
    ...
    function getValue()
    {
		...
		if($aVersions['LCDV_CODE'] != ''){
			$aVersions['IMAGE'] = Pelican::$config["VISUEL_3D_PATH"]."?ratio=".Pelican::$config['VISUEL_3D_PARAM']['RATIO']."&version=".$aVersions['LCDV_CODE']."&quality=".Pelican::$config['VISUEL_3D_PARAM']['QUALITY']."&width=300&format=png&height=180&view=".Pelican::$config['VISUEL_3D_PARAM']['VIEW']."&client=".Pelican::$config['VISUEL_3D_PARAM']['CLIENT'];
