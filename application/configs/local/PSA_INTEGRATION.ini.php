...
/** Fichier de configuration de l'environnement d'INTEGRATION PSA **/
 ...
 * Base de donées
 */
Pelican::$config["DATABASE_HOST"] = "mastercdd"; // Entrée dans le fichier mysqlnd_ms_plugin.ini
Pelican::$config["DATABASE_TYPE"] = "mysql";
Pelican::$config["DATABASE_NAME"] = "CPW_INT";
...
Pelican::$config['DIRECTORY_LDAP']['filepath'] = Pelican::$config["DOCUMENT_INIT"] . '/application/configs/ldap.properties'; // pour utiliser le bouchon xml : mettre "/ldap.xml"
