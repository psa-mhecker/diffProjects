...
/** Fichier de configuration de l'environnement de PRODUCTION PSA - BACKOFFICE **/
 ...
 * Base de donn�es
 */
Pelican::$config["DATABASE_HOST"] = "masterprod"; // Entrée dans le fichier mysqlnd_ms_plugin.ini
...
Pelican::$config['DEBUG']['BAR'] = false;
Pelican::$config['DEBUG']['SHOW'] = false;
Pelican::$config['DEBUG']['PROFILING'] = false;
...
Pelican::$config['DIRECTORY_LDAP']['filepath'] = dirname(__FILE__).'/ldap.properties'; // pour utiliser le bouchon xml : mettre "/ldap.xml"
...
Itkg::$config['ITKG_APIS_GOOGLE']['authentication_provider']['PARAMETERS']['redirect_uri'] = 'http://callback-cppv2.interakting.com/callback.php';
