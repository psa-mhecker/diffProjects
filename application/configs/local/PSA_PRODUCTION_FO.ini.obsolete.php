...
/** Fichier de configuration de l'environnement de PRODUCTION PSA - FRONTOFFICE **/
 ...
 * Base de donn�es
 */
Pelican::$config["DATABASE_HOST"] = "slave1prod"; // Entrée dans le fichier mysqlnd_ms_plugin.ini
