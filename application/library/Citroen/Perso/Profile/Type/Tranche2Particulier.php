...
class Tranche2Particulier extends Type
{
    public function init()
    {
        $productType = \Citroen_View_Helper_Vehicule::getProductGamme($_SESSION[APP]['SITE_ID'], Detail::$preferredProduct);
        return $this->compareThreeFlags(Detail::$recentClient, 'Non', null, Detail::$trancheScore[Detail::$preferredProduct], 2, $productType, 'VP');
    }
}