...
class Configuration extends BaseConfiguration
{
    ...
    public function __construct()
    {
        ...
        $this->methodIdentifiers = array(
			...
			'getOptionalFeaturesInfo' => 'GetOptionalFeaturesInfo'
        );
        $this->models = array(
			...
			'getOptionalFeaturesInfo' => array(
                'request' => array(
                    'model' => 'Citroen\Service\Webstore\Model\GetOptionalFeaturesInfoRequest'
                ),
                'response' => array(
                    'model' => 'Citroen\Service\Webstore\Model\GetOptionalFeaturesInfoResponse',
                    'mapping' => array(
                        'GetOptionalFeaturesInfoResponse' => 'Citroen\Service\Webstore\Model\GetOptionalFeaturesInfoResponse'
                    )
                )
            ),
        );
