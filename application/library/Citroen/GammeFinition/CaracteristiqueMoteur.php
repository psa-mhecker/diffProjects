<?php
/**
 * Fichier de CaracteristiqueMoteur
 *
 * Classe de gestion des import des diverses informations des caractéristiques
 * des moteurs disponibles pour un véhicule à partir d'informations remontées
 ...
 */
class CaracteristiqueMoteur extends Gamme
{
    /* Nom de la table PHPFactory à utiliser pour y intégrer les données */
    private $sPHPFactoryTableName = '#pref#_ws_caracteristique_moteur';
    
    /* Nom de la dataclass correspondante dans le CSV fourni */
    private $sWSDataclassName = 'CMO';
    ...
    public function setColumnsImportMatching()
    {
        ...
        $this->aColumnsImportMatching[gamme_csv_energyCategory_field_WS]    = gamme_csv_energyCategory_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_engineDescription_field_WS] = gamme_csv_engineDescription_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_engineLabel_field_WS]       = gamme_csv_engineLabel_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_referenceLcdv_field_WS]     = gamme_csv_referenceLcdv_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_isEcoLabel_field_WS]        = gamme_csv_isEcoLabel_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_transmissionLabel_field_WS] = gamme_csv_transmissionLabel_field_PHPfact;
