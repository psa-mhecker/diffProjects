<?php
/**
 * Fichier de Finitions
 *
 * Classe de gestion des finitions disponibles pour un véhicule 
...
/**
 * Classe de gestion des finitions d'un véicule
 */
class Finitions extends Gamme
{
    /* Nom de la table PHPFactory à utiliser pour y intégrer les données */
    private $sPHPFactoryTableName = '#pref#_ws_finitions';
    
    /* Nom de la dataclass correspondante dans le CSV fourni */
    private $sWSDataclassName = 'FIN';
    ...
    public function setColumnsImportMatching()
    {
        ...
        $this->aColumnsImportMatching[gamme_csv_categoryName_field_WS]      = gamme_csv_categoryName_field_PHPfact;
        ...
        $this->aColumnsImportMatching[gamme_csv_primaryDisplayPrice_field_WS]   = gamme_csv_primaryDisplayPrice_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_previousFinitionCode_field_WS]  = gamme_csv_previousFinitionCode_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_v3DLcdv_field_WS]           = gamme_csv_v3DLcdv_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_v3DExterior_field_WS]       = gamme_csv_v3DExterior_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_v3DInterior_field_WS]       = gamme_csv_v3DInterior_field_PHPfact;
    }
