<?php
/**
 * Fichier de EquipementDisponible
 *
 * Classe de gestion des équipements disponibles à partir d'informations 
 * remontées par les WebServices PSA
 * 
 * @package Citroen
 * @subpackage Gamme
...
/**
 * Classe de gestion des équipement disponibles 
 */
class EquipementDisponible extends Gamme
{
    /* Nom de la table PHPFactory à utiliser pour y intégrer les données */
    private $sPHPFactoryTableName = '#pref#_ws_equipement_disponible';
    
    /* Nom de la dataclass correspondante dans le CSV fourni */
    private $sWSDataclassName = 'ESO';
    ...
    public function setColumnsImportMatching()
    {
        ...
        $this->aColumnsImportMatching[gamme_csv_equipementName_field_WS]    = gamme_csv_equipementName_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_lcdvCode_field_WS]          = gamme_csv_lcdvCode_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_disponibility_field_WS]     = gamme_csv_disponibility_field_PHPfact;
    }
