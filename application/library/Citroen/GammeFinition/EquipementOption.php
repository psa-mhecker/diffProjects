<?php
/**
 * Fichier de EquipementOption
 *
 * Classe de gestion des équipements en option pour une finition 
...
/**
 * Classe de gestion des équipement en option pour une finition
 */
class EquipementOption extends Gamme
{
    /* Nom de la table PHPFactory à utiliser pour y intégrer les données */
    private $sPHPFactoryTableName = '#pref#_ws_equipement_option';
    
    /* Nom de la dataclass correspondante dans le CSV fourni */
    private $sWSDataclassName = 'EPL';
