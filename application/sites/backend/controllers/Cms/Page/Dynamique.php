...
class Cms_Page_Dynamique_Controller extends Cms_Page_Controller{
    ...
    function ajaxAddZoneAction($area_id, $zone_id, $cpt) {
        ...
        $newBlockId = uniqid('new-dynamic-block-marker-');
        ...
        $form = '<span style="display:none;" class="'.htmlspecialchars($newBlockId).'"></span>'.$form;
...
JS;
        ...
        /*
        $form .= $this->oForm->createHidden("zone_multi_db[]", $cpt . '_' . $aZone["ZONE_TYPE_ID"]);
        */
