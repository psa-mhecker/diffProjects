...
class Cms_Page_Citroen_VehiculesNeufs extends Cms_Page_Citroen
{
    ...
    {	
        ...
        $return .= $controller->oForm->createRadioFromList($controller->multi."ZONE_ATTRIBUT2", t('VN_LOWKM'), array('1' => t("OUI"), '2' => t("NON")), ($controller->zoneValues['ZONE_ATTRIBUT2'] == '') ? '2' : $controller->zoneValues['ZONE_ATTRIBUT2'], false, $controller->readO);
