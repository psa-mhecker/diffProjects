...
class Cms_Page_Citroen_Global_Header_CtaMineur extends Cms_Page_Citroen
{
    ...
    public static function render(Pelican_Controller $controller)
    {
        ...
        $return .= $controller->oForm->createMultiHmvc($controller->multi."CTA", t('CTA'), array(
                "path" => Pelican::$config["APPLICATION_CONTROLLERS"] . "/Cms/Page/Citroen/Global/Header/CtaMineur.php",
                "class" => "Cms_Page_Citroen_Global_Header_CtaMineur",
                "method" => "multiCTA"
            ), Backoffice_Form_Helper::getPageZoneMultiValues($controller, 'CTA'), $controller->multi."CTA", $controller->readO, 3, true, true, $controller->multi."CTA");
        return $return;
    }
