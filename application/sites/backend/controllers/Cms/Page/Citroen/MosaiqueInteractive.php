...
class Cms_Page_Citroen_MosaiqueInteractive extends Cms_Page_Citroen
{
    public static function render(Pelican_Controller $controller)
    {
        ...
        $return .= $controller->oForm->createRadioFromList($controller->multi . 'ZONE_TITRE3', t('Activer le titre sur l’image'), array('0' => t("Non"), '1' => t("Oui")), $controller->zoneValues['ZONE_TITRE3'], true, $controller->readO);
