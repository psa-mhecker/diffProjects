...
class Cms_Page_Citroen_Iframe extends Cms_Page_Citroen
{
    ...
    public static function render(Pelican_Controller $controller)
    {
		...
		$return .= Backoffice_Form_Helper::getFormGroupeReseauxSociaux($controller, "ZONE_TITRE20", "PUBLIC");
		$return .= $controller->oForm->createMedia($controller->multi."MEDIA_ID2", t('VISUEL'), false, "image", "", $controller->zoneValues['MEDIA_ID2'], $controller->readO, true, false);
