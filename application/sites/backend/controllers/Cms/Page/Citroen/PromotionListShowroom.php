...
{  
    ...
    {  
		...
		$return .= $controller->oForm->createCheckBoxFromList($controller->multi."ZONE_TITRE2", t('PERSO_MASQUER_TRANCHE_PROMO'), array(1 => ""), $controller->zoneValues['ZONE_TITRE2'], false, $controller->readO);
