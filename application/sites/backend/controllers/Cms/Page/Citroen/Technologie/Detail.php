...
class Cms_Page_Citroen_Technologie_Detail extends Cms_Page_Citroen
{
    ...
    public static function render(Pelican_Controller $controller)
    {
        ...
        if($controller->zoneValues['ZONE_TEXTE3'] == ''){$controller->zoneValues['ZONE_TEXTE3'] = 0;}
        $return .= $controller->oForm->createRadioFromList($controller->multi . 'ZONE_TEXTE3', t('MASQUER_PAGE_DETAIL'), array('0' => t('NON'), '1' => t('OUI')), $controller->zoneValues['ZONE_TEXTE3'], true, $controller->readO);
        // SHARER todo
