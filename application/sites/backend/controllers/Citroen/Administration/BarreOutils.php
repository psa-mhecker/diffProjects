...
SQL;
    ...
    public function editAction()
    {
        ...
        $form .= $this->oForm->createInput("BARRE_OUTILS_TITRE_COURT", t('TITRE_COURT'), 255, "", false, $this->values['BARRE_OUTILS_TITRE_COURT'], $this->readO, 75);
        ...
        $form .= $this->oForm->createMedia("MEDIA_DS_VERTICAL", t('MEDIA_DS_VERTICAL'), false, "image", "", $this->values["MEDIA_DS_VERTICAL"], $this->readO, true, false);
        $form .= $this->oForm->createMedia("MEDIA_C_VERTICAL", t('MEDIA_C_VERTICAL'), false, "image", "", $this->values["MEDIA_C_VERTICAL"], $this->readO, true, false);
        $form .= $this->oForm->createMedia("MEDIA_TRANS_VERTICAL", t('MEDIA_TRANS_VERTICAL'), false, "image", "", $this->values["MEDIA_TRANS_VERTICAL"], $this->readO, true, false);
