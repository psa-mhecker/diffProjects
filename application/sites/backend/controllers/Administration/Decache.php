...
class Administration_Decache_Controller extends Pelican_Controller_Back
{
    ...
    public function saveAction()
    {
        ...
        $oConnection = Pelican_Db::getInstance();
        $siteLsql = "SELECT SITE_LABEL FROM #pref#_site WHERE SITE_ID = :site_id";
        $siteLabel = $oConnection->queryItem($siteLsql,array(":site_id"=>$decacheSiteId));
        $_SESSION[APP]['tmp_flash_message'] = array('message' => t("DECACHE_CACHE_CLEANED")." (".$siteLabel.")", 'type' => 'success');
    }
}
