...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0" align="center" width="450" class="login">
			<tr>
			...
			<tr>
				...
				<td align="left"><input type="radio" name="lang" id="lang0" value="1" checked="checked"/>{'LANG_FR'|t}&nbsp;&nbsp;<input type="radio" name="lang" id="lang1" value="2" />{'LANG_EN'|t}&nbsp;&nbsp;</td>
			</tr>
			<tr>
				<td colspan="3">&nbsp;</td>
			</tr>
