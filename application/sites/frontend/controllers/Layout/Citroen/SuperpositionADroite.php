...
class Layout_Citroen_SuperpositionADroite_Controller extends Pelican_Controller_Front {
    ...
    public function indexAction() {
        ...
        if ($aData["ZONE_WEB"] == 1 || $aData["ZONE_MOBILE"] == 1) {
            ...
            $this->assign('MEDIA_TITLE2', $mediaDetail2["MEDIA_TITLE"]);
