                                        <form action="index.php" method="post" name="form2"> 
                                         <table width="95%" border="0" cellspacing="0" cellpadding="1" align="center" class="poll"> 
                                          <thead> 
                                           <tr>
                                            <td style="font-weight: bold;">Zend Framework is used for?</td> 
                                           </tr> 
                                          </thead> 
                                          <tr> 
                                           <td align="center">
                                           ...
                                           <td> 
                                            <div align="center"> 
                                                                 <span class="art-button-wrapper">
                                                                  <span class="l"> </span>
                                                                  <span class="r"> </span>
                                                                  <input type="submit" name="task_button" class="art-button" value="{'Vote'|t}" />
                                                                 </span>&nbsp;
                                                                 <span class="art-button-wrapper">
                                                                  <span class="l"> </span>
                                                                  <span class="r"> </span>
                                                                  <input type="button" name="option" class="art-button" value="{'RESULTS'|t}" />
                                                                 </span> 
                                                                                                            </div> 
                                           </td> 
                                          </tr> 
