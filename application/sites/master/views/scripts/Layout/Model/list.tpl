{section name=index loop=$list}
						<div class="art-post" style="overflow:hidden;">
                            ...
                            <div class="art-post-inner art-article">
                                            ...
                                            <h2 class="art-postheader">
                                                <a href="{$list[index].CONTENT_CLEAR_URL}">{$list[index].CONTENT_TITLE}</a>
                                            </h2>
                                            </div>
			...
			{/if}
			{if $list[index].CONTENT_DISPLAY_PRINT}| <img class="art-metadata-icon" src="{$skin}/images/postprinticon.png" width="15" height="13" alt="Imprimer" onclick="document.location.href='{$list[index].CONTENT_CLEAR_URL}#print'" />
			{/if}
			...
			<a href="{$list[index].CONTENT_CLEAR_URL}#comment" title="Comments">Commentaires &#187;</a>
			{/if}
			</div>
...
<span class="art-button-wrapper">
	<span class="l"> </span>
	<span class="r"> </span>
	<input type="button" name="readmore" class="art-button" value="En savoir plus..." onclick="document.location.href='{$list[index].CONTENT_CLEAR_URL}'"/>
</span>
{else}
