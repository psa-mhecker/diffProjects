...
$(document).ready(function(){
    ...
    setTimeout(function(){
        $("#zone_triangles_mmd_1404").css({height : $("#zone_triangles_mmd_1404").width()+"px"});
    },200);
    setTimeout(function(){
...
$("#cta_intro_mmd1404").on("touchstart", function(event, auto){
    ...
    interval1_mmd1404 = setInterval(function(){
        if(auto1_mmd1404==5){
    ...
    timer_mmd1404 = setInterval(function(){
        next_mmd1404();
    },10000);
});
...
$("#carre2_mmd1404").on("touchstart", function(event, auto){
    $("#turn_mmd1404").animate({rotate : "145deg"},500);
...
$("#carre3_mmd1404").on("touchstart", function(event, auto){
    $("#turn_mmd1404").animate({rotate : "216deg"},500);
...
$("#carre4_mmd1404").on("touchstart", function(event, auto){
    $("#turn_mmd1404").animate({rotate : "290deg"},500);
...
$("#fond_carre5_mmd1404").on("touchstart", function(event, auto){
    $("#turn_mmd1404").animate({rotate : "365deg"},500);
...
$(".on_mmd1404").on("touchstart", function(event, auto){
    var id_mmd1404 = $(this).attr("id");
    var selec_mmd1404 = parseInt(id_mmd1404.substring(6,7));
    $("#on_btn1_slide4_mmd1404, #on_btn2_slide4_mmd1404, #on_btn3_slide4_mmd1404, #on_btn4_slide4_mmd1404, #on_btn5_slide4_mmd1404, #on_btn6_slide4_mmd1404, #on_btn7_slide4_mmd1404").animate({opacity : 0},0);
    $(this).animate({opacity: 1},0);
    $("#screen1_mmd1404, #screen2_mmd1404, #screen3_mmd1404, #screen4_mmd1404, #screen5_mmd1404, #screen6_mmd1404, #screen7_mmd1404").animate({opacity : 0}, 0);
    $("#screen"+selec_mmd1404+"_mmd1404").animate({opacity : 1},0);
    if(selec_mmd1404==1){$("#name_tablet_mmd1404").html("Climatisation");}
    else if(selec_mmd1404==2){$("#name_tablet_mmd1404").html("Aides à la conduite");}
    else if(selec_mmd1404==3){$("#name_tablet_mmd1404").html("Multimédia");}
    else if(selec_mmd1404==4){$("#name_tablet_mmd1404").html("Navigation");}
    else if(selec_mmd1404==5){$("#name_tablet_mmd1404").html("Paramètres");}
    else if(selec_mmd1404==6){$("#name_tablet_mmd1404").html("Citroën Multicity Connect");}
    else if(selec_mmd1404==7){$("#name_tablet_mmd1404").html("Téléphone");}
    auto2_mmd1404 = selec_mmd1404;
    if(auto!=="auto"){
        clearInterval(interval2_mmd1404);
        clearInterval(timer_mmd1404);
        timer_mmd1404 = setInterval(function(){
            next_mmd1404();
        },10000);
...
$(".btn_timeline_mmd1404").on("touchstart", function(){
    ...
    if(selec_mmd1404>current_slide_mmd1404){
        $("#slide"+current_slide_mmd1404+"_mmd1404").transition({left: "-100%"},300);
        $("#slide"+selec_mmd1404+"_mmd1404").transition({left: "100%"},0).transition({left: "0%"},300);
    ...
    if(selec_mmd1404==4){
        clearInterval(interval2_mmd1404);
        interval2_mmd1404 = setInterval(function(){
            if(auto2_mmd1404==8){
                $("#on_btn1_slide4_mmd1404").trigger("touchstart",["auto"]);
                auto2_mmd1404=1;
            }else{
                $("#on_btn"+auto2_mmd1404+"_slide4_mmd1404").trigger("touchstart",["auto"]);
                auto2_mmd1404++;
            }       
        },2000);
    }
...
function next_mmd1404(){
    ...
    if(current_slide_mmd1404==5){
        $("#slide5_mmd1404").transition({left: "-100%"},300);
        $("#slide1_mmd1404").transition({left: "100%"},0).transition({left: "0%"},300);
        ...
        if(current_slide_mmd1404==4){
            clearInterval(interval2_mmd1404);
            anim_fin_mmd1404();
        }
        if(current_slide_mmd1404==3){
            interval2_mmd1404 = setInterval(function(){
                if(auto2_mmd1404==8){
                    $("#on_btn1_slide4_mmd1404").trigger("touchstart",["auto"]);
                    auto2_mmd1404=1;
        ...
        $("#slide"+current_slide_mmd1404+"_mmd1404").transition({left: "-100%"},300);
        $("#slide"+(current_slide_mmd1404+1)+"_mmd1404").transition({left: "100%"},0).transition({left: "0%"},300);
...
function prev_mmd1404(){
    ...
    if(current_slide_mmd1404==1){
        anim_fin_mmd1404();
        clearInterval(interval1_mmd1404);
        $("#slide1_mmd1404").transition({left: "100%"},300);
        $("#slide5_mmd1404").transition({left: "-100%"},0).transition({left: "0%"},300);
...
$("#cta_end1_mmd1404").on("touchstart", function(){
        dataLayer.push({
            ...
            "eventAction": "Configurator::[universal vehicle name]",
...
$("#cta_end2_mmd1404").on("touchstart", function(){
        dataLayer.push({
            "event": "uaevent",
            "eventCategory": "Showroom::AnimationTopProduit::Step5",
            "eventAction": "Forms::TestDrive::[universal vehicle name]",
