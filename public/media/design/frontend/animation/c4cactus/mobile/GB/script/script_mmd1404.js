...
var mapTablet = {
	'#screen1_mmd1404':'CLIMATISATION',
	'#screen1_mmd1404':'AIDES A lA CONDUITE',
	'#screen1_mmd1404':'MULTIMEDIA',
	'#screen1_mmd1404':'NAVIGATION',
	'#screen1_mmd1404':'PARAMETRES',
	'#screen1_mmd1404':'CITROEN MULTICITY CONNECT',
	'#screen1_mmd1404':'TELEPHONE'
};
...
$(".btn_slide4_mmd1404").on("touchstart", function(event, auto){
	...
	dataLayer.push({
		...
		"eventLabel": mapTablet[$(this).attr('href').split('_')[4]]
	});
