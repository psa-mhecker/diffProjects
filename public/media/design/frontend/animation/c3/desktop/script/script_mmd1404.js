...
function anim_intro_mmd1404(){
	...
	$("#zone_car_intro_mmd1404").animate({left : "46px"}, 1400, "easeOutQuad");
	$({deg: 0}).animate(
			{deg: 600},
				{
					duration: 1400,
	...
	timeouts_mmd1404.push(setTimeout(function(){
		$("#zonetxt_intro_mmd1404").animate({top: "61px", opacity: 1},600);
	},900));
...
function anim_slide_mmd1404(next_mmd1404){
	if(next_mmd1404==1){
		...
		//initial
		$("#zone_pare_brise_part1_mmd1404").animate({top: "-203px", opacity: 1},0);
		$("#line1_part1_mmd1404, #line2_part1_mmd1404, #line3_part1_mmd1404, #line4_part1_mmd1404").animate({opacity: 0, "margin-left" : "0px"},0);
		$("#cloud1_mmd1404, #cloud2_mmd1404, #cloud3_mmd1404").transition({y : "0px"},0);
		$("#cloud1_mmd1404").clearQueue().animate({left : "200px"},0);
		$("#cloud2_mmd1404").clearQueue().animate({left : "750px"},0);
		$("#cloud3_mmd1404").clearQueue().animate({left : "900px"},0);

		//anim

		$("#cloud1_mmd1404").animate({left : "50px"},13400, "linear");
		$("#cloud2_mmd1404").animate({left : "600px"},13400, "linear");
		$("#cloud3_mmd1404").animate({left : "638px"},13400, "linear");

		timeouts_mmd1404.push(setTimeout(function(){
			$("#zone_pare_brise_part1_mmd1404").animate({top : "0px"},1400, "easeOutQuad");
		},800));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#line1_part1_mmd1404").animate({opacity : 1},1000);
		},1800));
		timeouts_mmd1404.push(setTimeout(function(){
			$("#line2_part1_mmd1404").animate({opacity : 1},1000);
		},2200));
		timeouts_mmd1404.push(setTimeout(function(){
			$("#line3_part1_mmd1404").animate({opacity : 1},1000);
		},2200));
		timeouts_mmd1404.push(setTimeout(function(){
			$("#line4_part1_mmd1404").animate({opacity : 1},1000);
		},2400));
		...
		//initial
		$("#cache_slide2_mmd1404").animate({left: "-228px"},0);
		$("#car_slide2_mmd1404").animate({left: "-470px", opacity: 1},0);
		$("#line1_part2_mmd1404, #line2_part2_mmd1404, #line3_part2_mmd1404, #people_mmd1404").animate({"margin-left" : "0px"},0);

		//anim
		$("#cache_slide2_mmd1404").animate({left: "1686px"},4000, "linear");
		$("#car_slide2_mmd1404").animate({left: "1440px"},4000, "linear");
		...
		//initial
		$("#img_slide3_mmd1404").animate({opacity : 1},0);
		$("#blue_slide3_mmd1404").animate({width : "0px", opacity: 1},0);
		$("#zone_txt_slide3_mmd1403").animate({left : "-80px", opacity: 0, "margin-left" : "0px"},0);
		$("#zone_car_slide3_mmd1404").animate({left : "-440px" ,"margin-left" : "0px"},0);
		$("#txt2_slide3_mmd1404, #txt4_slide3_mmd1404, #txt6_slide3_mmd1404").animate({top : "0px", scale : 1},0);
		$("#roue1_slide3_mmd1404, #roue2_slide3_mmd1404").animate({rotate : "0deg"},0);

		//anim
		timeouts_mmd1404.push(setTimeout(function(){
			$("#zone_txt_slide3_mmd1403").animate({left : "48px", opacity: 1},800);
			$("#blue_slide3_mmd1404").animate({width : "266px"},800);
		},400));
			...
			{deg: 1600},
				{
					duration: 3600,
					step: function(n){
						$("#roue1_slide3_mmd1404, #roue2_slide3_mmd1404").css({
							'transform':'rotate('+n+'deg)'
						});
					}
				}
		...
		timeouts_mmd1404.push(setTimeout(function(){
			$("#zone_car_slide3_mmd1404").animate({left : "300px"},3200, "easeOutQuad");
		},1000));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#txt2_slide3_mmd1404").animate({scale: 0.8, top : "3px"},300).animate({scale: 1, top : "0px"},200).animate({scale: 0.8, top : "3px"},300).animate({scale: 1, top : "0px"},200);
		},1900));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#txt4_slide3_mmd1404").animate({scale: 0.8, top : "3px"},300).animate({scale: 1, top : "0px"},200);
		},2800));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#txt6_slide3_mmd1404").animate({scale: 0.8, top : "3px"},300).animate({scale: 1, top : "0px"},200);
		},3400));
		...
		$("#zone_nav_tablet_mmd1404").animate({opacity: 0, "margin-left" : "0px", top: "140px"},0);
		$(".nav_tablet_mmd1404").removeClass("current_nav_tablet_mmd1404");
		$(".screen_tablet_mmd1404").css({opacity: 0});
		$(".tiret_part4_mmd1404").css({opacity: 0});
		$(".legende_part4_mmd1404").css({opacity: 0});
		...
		timeouts_mmd1404.push(setTimeout(function(){
			$("#zone_nav_tablet_mmd1404").animate({opacity : 1, top: "120px"},600);
		},800));
		timeouts_mmd1404.push(setTimeout(function(){
		...
		//initial
		$("#zone_voiture_part5_mmd1404").animate({left : "-660px", "margin-left" : "0px"},0);
		...
		//anim
			...
			timeouts_mmd1404.push(setTimeout(function(){
				$("#zone_voiture_part5_mmd1404").animate({left : "43px"},1500, "easeOutQuad");
			},200));
			...
			timeouts_mmd1404.push(setTimeout(function(){
				$("#txt_part5_mmd1404, #bandeau_part5_mmd1404").animate({opacity : 0},500);
			},6000));
...
function leave_slide_mmd1404(current_mmd1404){
	if(current_mmd1404==1){
		 ...
		 setTimeout(function(){
		 	$("#zone_pare_brise_part1_mmd1404").clearQueue().animate({opacity : 0},600,"easeInSine");
		 },500);
	}
	else if(current_mmd1404==2){
		$("#car_slide2_mmd1404").clearQueue().animate({opacity : 0},600,"easeInSine");
		$("#people_mmd1404").clearQueue().animate({"margin-left" : "-1500px"},600,"easeInSine");
		 setTimeout(function(){
		 ...
		 setTimeout(function(){
		 	$("#line3_part2_mmd1404").clearQueue().animate({"margin-left" : "-2500px"},600,"easeInSine");
		 },300);
	}
	else if(current_mmd1404==3){
		$("#blue_slide3_mmd1404, #img_slide3_mmd1404").clearQueue().animate({opacity : 0},600,"easeInSine");
		setTimeout(function(){
		 	$("#zone_txt_slide3_mmd1403").clearQueue().animate({"margin-left" : "-2000px"},600,"easeInSine");
		 },100);
		setTimeout(function(){
		 	$("#zone_car_slide3_mmd1404").clearQueue().animate({"margin-left" : "-2000px"},600,"easeInSine");
		 },200);
...
$("#cta_fin1_mmd1404").click(function(){
	dataLayer.push({
			...
			"eventAction": "Configurator::TestDrive::C3",
...
$(".picto_nav_mmd1404").click(function(){
	...
	if(selected_mmd1404 != id_mmd1404){
		...
		$(".tiret_part4_mmd1404").css({opacity: 0});
		$(".legende_part4_mmd1404").css({opacity: 0});
		$("#nav_tablet"+id_mmd1404+"_mmd1404").find(".tiret_part4_mmd1404").css({opacity: 1});
		$("#nav_tablet"+id_mmd1404+"_mmd1404").find(".legende_part4_mmd1404").css({opacity: 1});
