...
function anim_intro_mmd1404(){
	...
	$("#zone_car_intro_mmd1404").animate({left : "150px", top : "77px"},2400);
		$({deg: 0}).animate(
		{deg: -1200},
			{
				duration: 2400,
...
function anim_slide_mmd1404(next_mmd1404){
	if(next_mmd1404==1){
		...
		$("#coffre_mmd1404").animate({rotate : "-75deg"},0);
		...
		timeouts_mmd1404.push(setTimeout(function(){
			...
			$("#zone_car_slide1_mmd1404").animate({left : "565px"},2200, "easeOutQuad");
			$({deg: 0}).animate(
			{deg: -1000},
				{
					duration: 2200,
		...
		timeouts_mmd1404.push(setTimeout(function(){
			$("#stuff1_mmd1404").animate({left : "150px", top: "-15px"},500);
		},3800));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#stuff2_mmd1404").animate({left : "152px", top: "18px"},500);
			$("#stuff1_mmd1404").animate({opacity : 0},0);
		},4000));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#stuff3_mmd1404").animate({left : "210px", top: "-15px"},500);
			$("#stuff2_mmd1404").animate({opacity : 0},0);
		},4200));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#stuff4_mmd1404").animate({left : "210px", top: "30px"},500);
			$("#stuff3_mmd1404").animate({opacity : 0},0);
		},4600));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#stuff5_mmd1404").animate({left : "240px", top: "-15px"},500);
			$("#stuff4_mmd1404").animate({opacity : 0},0);
		},4800));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#stuff6_mmd1404").animate({left : "310px", top: "33px"},500);
			$("#stuff5_mmd1404").animate({opacity : 0},0);
		},5000));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#stuff7_mmd1404").animate({left : "310px", top: "-15px"},500);
		...
		$("#zone_drag_mmd1404").animate({opacity : 0},0);
		$("#image_drag_mmd1404").animate({height : "27px"},0);
		$("#draggable_mmd1404").animate({top: "0px"},0);
		...
		timeouts_mmd1404.push(setTimeout(function(){
			$("#zone_drag_mmd1404").animate({opacity : 1},400);
		},1000));

		timeouts_mmd1404.push(setTimeout(function(){
			$("#image_drag_mmd1404").animate({height : "123px"},400);
			$("#draggable_mmd1404").animate({top: "97px"},400);
		},1300));
...
$("#cta_fin1_mmd1404").click(function(){
	dataLayer.push({
		...
		"eventAction": "Forms::TestDrive::C4Picasso",
...
$("#cta_fin2_mmd1404").click(function(){
	dataLayer.push({
		"event": "uaevent",
		"eventCategory": "Showroom::AnimationTopProduit::Step5",
		"eventAction": "Configurator::TestDrive::C4Picasso",
