...
$(document).ready(function() {
	...
	$(window).resize(function() {
			$(".superposition-right").each(function() {
			  ...
			  if (globalHeight<backgroundHeight) { $(this).css("margin-bottom", "0px"); }
			});
    });
    ...
    $('.intersticiel-popin').each(function() {
        ...
        if (timer !== undefined) {
            var closeTimer = setTimeout(function() {
                $(oThis).hide().delay(50).queue(function(){$(oThis).remove();});
    ...
    $('section.cls2colonnemixte .col, section .col .zonetexte2colmixte').each(function() {
        if(!$(this).children().last().hasClass('thumbs')){ $(this).children().last().css("margin-bottom", 0); }
    });
    ...
    */
    ...
    $('.scroll').each(function() {
        if (!$(this).parents('.layertip:first').length) {
            $(this).jScrollPane({
                autoReinitialise: ($('html').hasClass('ie ie11') ||  $('html').hasClass('ie ie9')) ? false : true,
...
var sticky = {
    ...
    build: function() {
        ...
        if(url.hash){
            ...
            //console.log(urlId);
            if(urlId!="sticky"){
                setTimeout(function(){sticky.go(urlId);},5000);
...
var dragnchange = {
    ...
    set: function(me, newPos) {http://cppv2-dev-media.interakting.com/image/65/7/1500x646-concept-car-citroen-revolte-heritage-transgressif.2657.76.jpg
        ...
        $('.folder').each(function(){
            ...
            if(a.length>0){
                ...
                if (aId == selector){
                    ...
                    $(this).trigger('click');
                    chargeIframeDeploy('FormulaireDeploy'+id);
                }
            }
        });
    }
                    ...
                    groupElementsLoop:
                        for (var j = 0; j < titlesLgth; j++) {
                            ...
                            if (globalmax <= h) {
                                ...
                                if (h > 50) {
                                    if (indexMaxCtaA == -1) indexMaxCtaA = j; // Ne fait rien // La premi�re fois on renseigne l'index du CtaA
                                }
                                if (indexMaxCtaA != -1) indexMaxCtaB = j; // A la deuxi�me passe on renseigne l'index du CtaA
