 ...
 */
class Version20150401112722 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        $this->addSql("INSERT INTO `psa_zone` (`ZONE_ID`, `ZONE_TYPE_ID`, `ZONE_LABEL`, `ZONE_FREE`, `ZONE_COMMENT`, `ZONE_BO_PATH`, `ZONE_FO_PATH`, `ZONE_IFRAME`, `ZONE_AJAX`, `ZONE_PROGRAM`, `ZONE_DB_MULTI`, `ZONE_IMAGE`, `ZONE_CATEGORY_ID`, `ZONE_CONTENT`, `PLUGIN_ID`) VALUES
          (802, 1, 'NDP_PC23_Mur_Media', 0, NULL, 'Cms_Page_Ndp_Pc23MurMedia', 'Pc23MurMediaStrategy', 0, 0, 0, NULL, NULL, 28, 0, '')
        ");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("DELETE FROM psa_zone where ZONE_id = 802");
    }
}
