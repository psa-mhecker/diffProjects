 ...
 */
class Version20150624121047 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE `psa_page_multi_zone_multi_cta`
          ADD CONSTRAINT `FK_605F4639B4EDB1E5622E2C2` FOREIGN KEY (`PAGE_ID`, `LANGUE_ID`) REFERENCES `psa_page` (`PAGE_ID`, `LANGUE_ID`) ON DELETE CASCADE,
          ADD CONSTRAINT `FK_605F4639B4EDB1E5622E2C229381310BA07F8665F342437F55F4D23FD9DF` FOREIGN KEY (`PAGE_ID`, `LANGUE_ID`, `PAGE_VERSION`, `AREA_ID`, `ZONE_ORDER`, `PAGE_ZONE_MULTI_ID`, `PAGE_ZONE_MULTI_TYPE`) REFERENCES `psa_page_multi_zone_multi` (`PAGE_ID`, `LANGUE_ID`, `PAGE_VERSION`, `AREA_ID`, `ZONE_ORDER`, `PAGE_ZONE_MULTI_ID`, `PAGE_ZONE_MULTI_TYPE`) ON DELETE CASCADE,
          ADD CONSTRAINT `FK_605F4639E1DF977A` FOREIGN KEY (`CTA_ID`) REFERENCES `psa_cta` (`ID`);');
        $this->addSql('ALTER TABLE `psa_page_multi_zone_multi_cta_cta`
          ADD CONSTRAINT `FK_F83E379AD6FB46C7151C14B4EDB1E5622E2C229381310BA07F8665F34243` FOREIGN KEY (`PAGE_ZONE_CTA_ID`, `PAGE_ZONE_CTA_TYPE`, `PAGE_ID`, `LANGUE_ID`, `PAGE_VERSION`, `AREA_ID`, `ZONE_ORDER`, `PAGE_ZONE_MULTI_ID`, `PAGE_ZONE_MULTI_TYPE`) REFERENCES `psa_page_multi_zone_multi_cta` (`PAGE_ZONE_CTA_ID`, `PAGE_ZONE_CTA_TYPE`, `PAGE_ID`, `LANGUE_ID`, `PAGE_VERSION`, `AREA_ID`, `ZONE_ORDER`, `PAGE_ZONE_MULTI_ID`, `PAGE_ZONE_MULTI_TYPE`) ON DELETE CASCADE,
          ADD CONSTRAINT `FK_F83E37B4EDB1E5622E2C2` FOREIGN KEY (`PAGE_ID`, `LANGUE_ID`) REFERENCES `psa_page` (`PAGE_ID`, `LANGUE_ID`) ON DELETE CASCADE,
          ADD CONSTRAINT `FK_F83E37B4EDB1E5622E2C229381310BA07F8665F342437F55F4D23FD9DFAC` FOREIGN KEY (`PAGE_ID`, `LANGUE_ID`, `PAGE_VERSION`, `AREA_ID`, `ZONE_ORDER`, `PAGE_ZONE_MULTI_ID`, `PAGE_ZONE_MULTI_TYPE`) REFERENCES `psa_page_multi_zone_multi` (`PAGE_ID`, `LANGUE_ID`, `PAGE_VERSION`, `AREA_ID`, `ZONE_ORDER`, `PAGE_ZONE_MULTI_ID`, `PAGE_ZONE_MULTI_TYPE`) ON DELETE CASCADE,
          ADD CONSTRAINT `FK_F83E37E1DF977A` FOREIGN KEY (`CTA_ID`) REFERENCES `psa_cta` (`ID`);');
    }
