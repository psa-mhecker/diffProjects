...
class StructureBSquare extends AbstractStructure
{
    ...
    public function getFormats()
    {
        ...
        $formats[] = array('method' => 'getMediaId4', 'formatId' => self::NDP_MURMEDIA_BIG_SQUARE, 'size' => $size);
