...
/**
 * Data source for Pc63LienBoussole block
 */
class Pc63LienBoussoleDataSource extends AbstractDataSource
{
    /**
    ...
    public function fetch(ReadBlockInterface $block, Request $request, $isMobile)
    {
        ...
        $data = [];
        $data['pageZoneMultis'] = $block->getMultisByType(PsaPageZoneMulti::PAGE_ZONE_MULTI_TYPE_COMPASS_LINK);
