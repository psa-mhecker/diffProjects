...
var imgPath = libDir+"/Pelican/Hierarchy/Tree/public/menu/";
...
function displayMenuItem(menuId) {
	...
	if (menu[menuId].description!='-')
	{
		...
		sHTML += "<td style='padding-left:5px;padding-right:5px;color:" + menuFontColor + ";font-family : " + menuFont + ";font-size : " + menuSize + ";text-align : " + menuAlign + ";'>" + menu[menuId].description.replace(" ","&nbsp;") + "</td><td style='padding-right:2px' align=right width="+nArrowWidth+">"
		if (menu[menuId].numChild>0)
		{
			if ((orientation==0)&&(menu[menuId].levelId==0))
			{
...
function DrawMenu ()  {
	...
	{
		lw_createLayer("menu_level_"+i,0,0,0,0,layerbgcolor,layerbordercolor,100)
	}
