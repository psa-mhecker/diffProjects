<?php
    ...
    class Pelican_Calendar_Display
    {
         ...
         */
        public function Pelican_Calendar_Display($nameModuleCalendar, $pathModuleCalendar, $month, $year, $longDayName = true)
        {
            if ($month == '') {
                $month = date('n');
            }
         ...
         * @return string $HTMLCalendarext
         */
        public function Render($calendarext)
        {
         ...
         */
        public function variableSpecificJS($nameVariable, $valueVariable)
        {
            $variableSpecificJS = '
         ...
         * @return string $includesJS
         */
        public function includeSpecificJS($pathJS)
        {
            $includesJS = '
				<!-- JS spécifique du module  -->
