<?php
    ...
    class Pelican_Calendar_Extended extends Pelican_Calendar
    {
         ...
         */
        public $LongDayName = false;

        public function Pelican_Calendar_Extended()
        {
        }
        /**
        ...
        public function SetLongMonthName($val = false)
        {
            $this->LongMonthName = $val;
        }
        /* emplois de nom de jour complet */
        public function SetLongDayName($val = false)
        {
            $this->LongDayName = $val;
        }
        public function getNextXdayFromNow($NbrDay = 1)
        {
            $dateD = date("d-m-y");
            $aDate = explode('-', $dateD);
         ...
         */
        public function SetNextXdayFromNow($NbrDay = 1)
        {
            $dateD = date("d-m-y");
            $aDate = explode('-', $dateD);
            $this->XnetDay = parent::getNextXday($aDate[0], $aDate[1], $aDate[2], $NbrDay);
        ...
        public function GetCalendarHTMLArray()
        {
            if ($this->XnetDay) {
                $this->aHTML = array();
                foreach ($this->XnetDay as $Myday) {
