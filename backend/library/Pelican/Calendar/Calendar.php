<?php
    ...
    class Pelican_Calendar
    {
         ...
         */
        public function Pelican_Calendar()
        {
        }
         ...
         * @return unknown
         */
        public function getDayNamesLong()
        {
         ...
         * @param unknown $names
         */
        public function setDayNamesLong($names)
        {
        ...
        */
         ...
         */
        public function setCalendarLink($link, $imgDirectory)
        {
            $this->link = $link;
         ...
         * @private
         */
        public function getNextXday($d, $m, $y, $nbrday = 1)
        {
            $s = "";
            $d = $this->formatDay($d);
         ...
         * @private
         */
        public function formatMonth($mois)
        {
            if ($mois < 10) {
                return "0".$mois;
            } else {
         ...
         * @private
         */
        public function formatDay2($day)
        {
            if ($day < 10) {
                return "0".$day;
            } else {
         ...
         * @private
         */
        public function getFrenchDate($d, $m, $y, $full = false)
        {
            $d = $this->formatDay($d);
            $a = $this->adjustDate($m, $y);
            $month = $a[0];
         ...
         * @private
         */
        public function getFrenchMonth($m, $full = false)
        {
            if ($full) {
