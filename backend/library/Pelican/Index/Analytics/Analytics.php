...
{
    // getTag
    public function getBackTag(&$oForm, $id, $site, $readO, $section = "", $rubrique = "", $param = "pid")
    {
    ...
    public function getContentTag($complementCybertag = "", $lang_code = "")
    {
        if (! isset($_GET["cid"])) {
            $_GET["cid"] = "";
        }
    ...
    public function cleanCybertag($text)
    {
        $return = $text;
