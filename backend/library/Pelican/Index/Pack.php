...
class Pelican_Index_Pack
{
     ...
     * @return __TYPE__
     */
    public static function minify($content, $type)
    {
         ...
         * @return __TYPE__
         */
        public function convertPathsToAbsolute($content, $path)
        {
         ...
         * @return __TYPE__
         */
        public function unifyDirSeparator($path)
        {
         ...
         * @return __TYPE__
         */
        public function preventLeadingSlash($path)
        {
