 ...
 *
 * If you want to use a custom error logger, set this to your Pelican_Log
 * instance. Your object should have a method log(string $message).
 *
 * @todo Pelican_Cache system does not have error logging yet.
 */
 ...
 * E.g. '/home/accountname/index_html' or 'c:\\xampp\\htdocs'
 *
...
/*
 * Pelican_Cache file locking. Set to false if filesystem is NFS. On at least one
 ...
 * warning Pelican_Index_Comment at the top of the CSS output. To resolve this you can either
...
/*
 * Maximum age of browser Pelican_Cache in seconds. After this period, the browser
 ...
 * Pelican_Cache files when source file changes are made too frequently (e.g. more than
 * once an hour).
 *
 ...
 * this accordingly.
 */
$min_libPath = dirname(__FILE__).'/library';
