 ...
 * and place the file "class.JavaScriptPacker.php" in /library (or your
 * include_path).
 *
...
if (false === (@include 'class.JavaScriptPacker.php')) {
    trigger_error(
        ...
        .'//code.google.com/p/minify/source/browse/trunk/min/library/Minify/Packer.php', E_USER_ERROR
    );
}
