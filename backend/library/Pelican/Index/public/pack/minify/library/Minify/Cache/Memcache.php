...
/**
 * Memcache-based Pelican_Cache class for Minify.
 *
 * <code>
...
class Minify_Cache_Memcache
{
     ...
     * Write data to cache.
     *
     * @param string $id   Pelican_Cache id
     * @param string $data
     *
     * @return bool success
     */
    ...
    /**
     * Get the size of a Pelican_Cache entry.
     *
     * @param string $id Pelican_Cache id
     *
    ...
    /**
     * Does a valid Pelican_Cache entry exist?
     *
     * @param string $id       Pelican_Cache id
    ...
    // Pelican_Cache of most recently fetched id
    private $_lm = null;
    private $_data = null;
    private $_id = null;
