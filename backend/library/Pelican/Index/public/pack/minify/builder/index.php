...
ob_start();
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD Pelican_Html 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd">
<head>
...
>may reduce the benefit of proxy Pelican_Cache servers</a>.</p>
...
<h2>Minify URI</h2>
<p>Place this URI in your Pelican_Html to serve the files above combined, minified, compressed and
with Pelican_Cache headers.</p>
<table id=uriTable>
...
$serveOpts = array(
    ...
    ,'lastModifiedTime' => max(
        // regenerate Pelican_Cache if either of these change
        filemtime(__FILE__), filemtime(dirname(__FILE__).'/../config.php')
    )
    ,'minifyAll' => true
