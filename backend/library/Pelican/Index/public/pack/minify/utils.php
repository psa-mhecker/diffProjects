<?php
/**
 * Utility functions for generating group URIs in Pelican_Html files.
 *
 * Before including this file, /min/library must be in your include_path.
 */
 ...
 * </code>
 *
 * If you do not want ampersands as Pelican_Html entities, set Minify_Build::$ampersand = "&"
...
function Minify_groupUri($group, $forceAmpersand = false)
{
    ...
    return _Minify_getBuild($group)->uri(
        '/'.basename(dirname(__FILE__)).$path, $forceAmpersand
    );
}
 ...
 * the Pelican_Cache if it's older than this timestamp.
 *
 * <code>
 * // simplistic Pelican_Html cache system
 * $file = '/path/to/var/cache/file';
