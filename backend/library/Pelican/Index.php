...
class Pelican_Index
{
     ...
     * @return mixed
     */
    public static function registerJquery($name, $action = '', $value = "")
    {
        static $jquery;
     ...
     * @return __TYPE__
     */
    public static function directJquery($name, $directOutput = false)
    {
        $return = "";
