...
class PhpSecInfo_Test_Cgi_Force_Redirect extends PhpSecInfo_Test_Cgi
{
    ...
    public function _setMessages()
    {
        ...
        $this->setMessageForResult(PHPSECINFO_TEST_RESULT_WARN, 'en', "force_redirect is disabled.  In most cases, this is a <strong>serious</strong> Pelican_Security vulnerability.  Unless you are absolutely sure this is not needed, enable this setting");
    }
}
