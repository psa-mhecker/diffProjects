...
class Pelican_Debug
{
     ...
     * @var __TYPE__ __DESC__
     */
    public static $style = "font:Verdana,Helvetica,Arial;font-size:11px;color:black";
    //'security'
    //'xdebug'
     ...
     * @return __TYPE__
     */
    public static function buildDebug($debugVar, $debugName, $origine, $full = true)
    {
        if ($full) {
     ...
     * @return __TYPE__
     */
    public static function add($debugVar, $debugName = "", $directOutput = false, $excludeFile = array(), $full = true)
    {
     ...
     */
    public static function showVar($val)
    {
         ...
         * défaut
         */
        public static function showArrayVar($tab, $nomIndice = "indice")
        {
            $return = "";
            if (count($tab) > 0) {
...
#PDebug{color:#000;margin-left:1px;margin-top:1px;position:absolute;top:0;z-index:1000;}
