...
abstract class Pelican_Db
{
    ...
    public static $IDENTITY_TYPES = array(
        self::IDENTITY,
    );
     ...
     * @return string
     */
    public function getItem($query, $param = array(), $paramLob = array())
    {
...
<xs:schema attributeFormDefault="unqualified" elementFormDefault="qualified" xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <xs:element name="'.$root.'">
    ...
    public function getXSDType($type)
    {
         ...
         * @access private
         */
        protected function initTimeQuery()
        {
            $mtime = microtime();
            $mtime = explode(" ", $mtime);
         ...
         * @param string $query Chaine SQL
         */
        protected function displayTimeQuery($query)
        {
            $mtime = microtime();
            $mtime = explode(" ", $mtime);
    ...
    public function decimalToBind($value)
    {
        ...
        */
        ...
        private function updateRecord($action, $table, $fieldSet, $assoc, $getSQL = false)
        {
             ...
             * @return string
             */
            protected function formatField($value, $type)
            {
                if ($this->isNum($type)) {
                    if (empty($value)) {
                        if ($value == "0") {
     ...
     */
             ...
             */
            public function updateParentReferenceWithOrder($StrNomTable, $StrChampOrdre, $order, $StrChampId, $id, $strChampPivot, $pivotId, $strComplement = "")
            {
                if ($strComplement != "") {
             ...
             */
            abstract public function query($query, $param = array(), $paramLob = array(), $debug = false);
             ...
             * @return string
             */
            abstract public function queryItem($query, $param = array(), $paramLob = array(), $light = true, $debug = false);
             ...
             * @return array
             */
            abstract public function queryObj($query, $param = array(), $paramLob = array(), $light = true, $debug = false);
             ...
             * @return array
             */
            abstract public function queryRow($query, $param = array(), $paramLob = array(), $light = true, $debug = false);
             ...
             * @return array
             */
            abstract public function queryTab($query, $param = array(), $paramLob = array(), $light = true, $debug = false);
             ...
             */
            abstract public function duplicateRecord($table, $key, $oldValue, $newValue);
             ...
             * @return string
             */
            abstract public function getCaseClause($field, $aClause, $defaultValue);
             ...
             * @return string
             */
            abstract public function getConcatClause($aValue);
             ...
             * @return string
             */
            abstract public function getCountSQL($query, $countFields);
             ...
             * @return array
             */
            abstract public function getDbInfo($type, $name = "");
             ...
             * @return string
             */
            abstract public function getDateAddClause($date, $interval);
             ...
             * @return string
             */
            abstract public function getDateDiffClause($date1, $date2);
             ...
             * @return string
             */
            abstract public function getLastOid();
             ...
             * @return string
             */
            abstract public function getLimitedSQL($query, $min, $length);
             ...
             * @return string
             */
            abstract public function getNVLClause($clause, $value);
             ...
             * @return string
             */
            abstract public function getNextId($table);
             ...
             * @return string
             */
            abstract public function getSearchClause($field, $value, $position = 0, $bindName = "", &$aBind, $join = "OR");
             ...
             * @return string
             */
            abstract public function dateSqlToString($dateField, $hour = false, $complement = "");
             ...
             * @return string
             */
            abstract public function dateSqlToStringShort($dateField);
             ...
             * @return string
             */
            abstract public function dateStringToSql($strChaine, $hour = true);
             ...
             * @return string
             */
            abstract public function dateToMonth($dateField);
             ...
             * @return string
             */
            abstract public function dateToYear($dateField);
             ...
             * @return __TYPE__
             */
            abstract public function nativeType($type);
             ...
             * @return __TYPE__
             */
            abstract public function getFieldDefaultDDL($default, $type, $null);
             ...
             * @return __TYPE__
             */
            abstract public function getFieldIncrementDDL($increment, $type = "");
             ...
             * @return __TYPE__
             */
            abstract public function getFieldNullDDL($null);
             ...
             * @return __TYPE__
             */
            abstract public function getFieldTypeDDL($type, $length, $precision);
             ...
             * @return __TYPE__
             */
            abstract public function getIncludedKeysDDL($table, $aFields);
             ...
             * @return __TYPE__
             */
            abstract public function getIndexDDL($table, $name, $aFields, $unique = false);
             ...
             * @return __TYPE__
             */
            abstract public function getPrimaryKeyDDL($table, $name, $aFields);
             ...
             * @return __TYPE__
             */
            abstract public function getReferencesDDL($table, $name, $childField, $source);
             ...
             * @return __TYPE__
             */
            abstract public function getSequenceDDL($name, $start = "", $increment = "");
             ...
             * @return __TYPE__
             */
            abstract public function getUniqueKeyDDL($table, $name, $aField);
             ...
             * @return __TYPE__
             */
            abstract public function getUpdateSequenceDDL($table, $field, $sequence_name);
             ...
             * @return __TYPE__
             */
            abstract public function getEndDDL($type);
             ...
             */
            public function prepareBind(&$query, &$param = array(), &$paramLob = array(), $format = "?")
            {
                //		debug($query);
                $esc = "___";
                if (!$this->allowBind) {
                 ...
                 * @return Pelican_Db
                 */
                public static function useDb($app = "")
                {
                    ...
                    if (!isset($aParams["DATABASE_HOST"])) {
                        $aParams["DATABASE_HOST"] = "";
                    }
                    if (!isset($aParams["DATABASE_PORT"])) {
                        $aParams["DATABASE_PORT"] = "";
                    }
                 ...
                 * @return string
                 */
                public static function addSlashesGPC($chaine)
                {
                 ...
                 * @return string
                 */
                public static function stripSlashesGPC($chaine)
                {
                 ...
                 * @return string
                 */
                public static function stripSlashesSQL($chaine)
                {
                 ...
                 * @return string
                 */
                public static function arrayMin($tab)
                {
                    $tabMin = "";
                 ...
                 * @return mixed
                 */
                public function arrayToBind($aDataValues)
                {
                    $aBind = array();
                 ...
                 */
                public function log500($host, $content)
                {
