...
class EnclosureItem extends HtmlDescribable
{
    ...
    var $language, $title;
    /*
     * For use with another extension like Yahoo mRSS Warning : These variables might not show up in later release / not finalize yet! var $width, $height, $title, $description, $keywords, $thumburl;
     */
    var $additionalElements = Array();
}
 ...
 * a feed, item or image html field (probably a description).
 * Output is
...
class FeedHtmlField
{
     ...
     * 
     * @param $string: if
     *            given, sets the rawFieldContent property
     */
...
class UniversalFeedCreator extends FeedCreator
{
     ...
     * @param
     *            string format format the feed should comply to. Valid values are:
     ...
     * After the file is saved, an HTTP redirect
     ...
     *
     * @param
     *            format	string	format the feed should comply to. Valid values are:
     *            "PIE0.1" (deprecated), "mbox", "RSS0.91", "RSS1.0", "RSS2.0", "OPML", "ATOM0.3".
     */
...
class FeedCreator extends HtmlDescribable
{
    ...
    function _redirect ($filename)
    {
        ...
        /*
         * no caching at all, doesn't seem to work as good: Header("Cache-Control: no-cache"); Header("Pragma: no-cache");
         */
    ...
    /**
     * Saves this feed as a file on the local disk.
     * After the file is saved, a redirect
...
class FeedDate
{
     ...
     *            optional the date this FeedDate will represent. If not specified, the current date and time is used.
     */
...
class RSSCreator10 extends FeedCreator
{
     ...
     * The feed will be compliant to RDF Site Summary (RSS) 1.0.
 ...
 * produce valid atom files.
 * For example, you have to specify either an editor
...
class HTMLCreator extends FeedCreator
{
     ...
     * hence this variable.
     * There's no equivalent on item level, but of course you can
