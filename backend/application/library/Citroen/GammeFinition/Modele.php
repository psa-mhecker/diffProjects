 ...
 * Fichier de Modele.
 *
 * Classe de gestion des import des modèles de véhicules  à partir
 * d'informations remontées par les WebServices PSA
 *
...
class Modele extends Gamme
{
    ...
    public function setColumnsImportMatching()
    {
        ...
        $this->aColumnsImportMatching[gamme_csv_label_field_WS] = gamme_csv_label_field_PHPfact;
