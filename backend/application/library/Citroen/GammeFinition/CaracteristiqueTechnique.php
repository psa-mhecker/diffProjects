<?php
/**
 * Fichier de CaracteristiqueTechnique.
 *
 * Classe de gestion des import des diverses informations des caractéristiques
 * techniques des véhicules dans la base de données à partir d'informations remontées
 ...
 */
class CaracteristiqueTechnique extends Gamme
{
    /* Nom de la table PHPFactory à utiliser pour y intégrer les données */
    private $sPHPFactoryTableName = '#pref#_ws_caracteristique_technique';

    /* Nom de la dataclass correspondante dans le CSV fourni */
    private $sWSDataclassName = 'CTE';
    ...
    public function setColumnsImportMatching()
    {
        ...
        $this->aColumnsImportMatching[gamme_csv_rank_field_WS]              = gamme_csv_rank_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_name_field_WS]              = gamme_csv_name_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_lcdvCode_field_WS]          = gamme_csv_lcdvCode_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_value_field_WS]             = gamme_csv_value_field_PHPfact;
    }
