<?php
/**
 * Fichier de EnergieMoteur.
 *
 * Classe de gestion des import des informations sur l'énergie des moteurs
 * partir d'informations remontées par les WebServices PSA
 *
...
class EnergieMoteur extends Gamme
{
    ...
    public function setColumnsImportMatching()
    {
        ...
        $this->aColumnsImportMatching[gamme_csv_description_field_WS]       = gamme_csv_description_field_PHPfact;
        $this->aColumnsImportMatching[gamme_csv_pictoURL_field_WS]          = gamme_csv_pictoURL_field_PHPfact;
    }
