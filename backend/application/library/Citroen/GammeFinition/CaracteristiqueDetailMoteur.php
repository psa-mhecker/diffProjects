<?php
/**
 * Fichier de CaracteristiqueDetailMoteur.
 *
 * Classe de gestion des import des informations détaillées sur les moteurs
 ...
 */
class CaracteristiqueDetailMoteur extends Gamme
{
    /* Nom de la table PHPFactory à utiliser pour y intégrer les données */
    private $sPHPFactoryTableName = '#pref#_ws_caracteristique_detail_moteur';

    /* Nom de la dataclass correspondante dans le CSV fourni */
    private $sWSDataclassName = 'CDM';
    ...
    public function setColumnsImportMatching()
    {
        ...
        $this->aColumnsImportMatching[gamme_csv_caractKey_field_WS]         = gamme_csv_caractKey_field_PHPfact;
