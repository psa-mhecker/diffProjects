...
if (isset($_SERVER["HTTPS"])) {
    ...
    if (! empty($_SERVER['HTTP_CLIENT_HOST'])) {
        if (strpos($_SERVER['HTTP_CLIENT_HOST'], '.peugeot.com') !== false && ! strpos($_SERVER['HTTP_CLIENT_HOST'], '.citroen.com.')) {
            Pelican::$config["SERVER_PROTOCOL"] = "https";
        }
    }
}
...
Pelican::$config["CACHE_FW_ROOT"] = Pelican::$config["VAR_ROOT"]."/cache/application";
 ...
 */
Pelican::$config['TRANSLATION_ROOT'] = Pelican::$config['VAR_ROOT'] . '/i18n/';
Pelican::$config['TRANSLATION_EXPORT'] = Pelican::$config['TRANSLATION_ROOT'] . 'export/';
Pelican::$config['TRANSLATION_IMPORT'] = Pelican::$config['TRANSLATION_ROOT'] . 'import/';
Pelican::$config['TRANSLATION_ROOT_FO'] = getenv('FRONTEND_APP_PATH').'/app/Resources/translations/';
...
Pelican::$config["VAR_VIEW_COMPILES_ROOT"] = getenv('BACKEND_VAR_PATH').'/cache/views_compiles';
Pelican::$config["VAR_CACHE_VIEWS"] = getenv('BACKEND_VAR_PATH').'/cache/views';
