 ...
 * Base de données
 */
Pelican::$config["DATABASE_HOST"] = "slave3prod";
Pelican::$config["DATABASE_TYPE"] = "mysql";
Pelican::$config["DATABASE_NAME"] = "NDP_00";
Pelican::$config["DATABASE_USER"] = "mzpndpdb";
Pelican::$config["DATABASE_PASS"] = "XXXXXXX";
...
if (isset($_SERVER['HTTP_CLIENT_HOST']) && $_SERVER['HTTP_CLIENT_HOST'] !== $_SERVER['HTTP_HOST'])
{
  // Accès à partir de l'internet
    ...
    Pelican::$config["HTTP_BACKEND"] = "admin-ndp.peugeot.com";
...
{ // Accès à partir de l'intranet
	...
	Pelican::$config["HTTP_BACKEND"] = "admin.ndp.inetpsa.com";
...
Pelican::$config['PROXY']['LOGIN'] = 'mzpndp00';
Pelican::$config['PROXY']['PWD'] = 'w6oza3so';
