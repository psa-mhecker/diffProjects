...
Pelican::$config["DATABASE_NAME"] = "NDP_INT";
...
//Pelican::$config["IM_ROOT"] = dirname(__FILE__).'/../../../../bin/gm-quant.sh gm convert';
Pelican::$config["PNGQUANT_ROOT"] = "/users/ndp00/modules/pngquant/bin/pngquant"; 
Pelican::$config["JPEGTRAN_ROOT"] = "/users/ndp00/modules/jpeg-9a/bin/jpegtran"; 
