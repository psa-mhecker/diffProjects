...
if (class_exists('Itkg')) {
    ...
    Itkg::$config['ITKG_APIS_GOOGLE_YOUTUBE_V3_YOUTUBE'] = array(
        ...
        'authentication_provider' => array(
            ...
            'PARAMETERS' => array(
                ...
                'redirect_uri' => Itkg::$config['ITKG_APIS_GOOGLE']['authentication_provider']['PARAMETERS']['redirect_uri'],
                // uri a surcharger par la page appelante
        ...
        'PARAMETERS' => array(
            ...
            // uri a surcharger selon les objets à appeler (/videos, /search, /channels ...)
    ...
    Itkg::$config['ITKG_APIS_STREAMLIKE_V2_STREAMLIKE'] = array(
      'configuration' => 'Itkg\Apis\Streamlike\V2\Streamlike\Configuration',
      'class'         => 'Itkg\Apis\Streamlike\V2\Streamlike',
      'authentication_provider' => array(
          //'TYPE' => 'oauth2',
        'PARAMETERS' => array(
          'id' =>  'streamlike_streamlike_v2'
        ),
      ),
      'PARAMETERS' => array(
        'host' => 'http://cdn.streamlike.com',
        'uri'  => '/ws/playlist', // uri a surcharger selon les objets à appeler (/playlist, /media ...)
        'disableLogTrame' => true,
        'headers' => array(
          'Content-Type' => 'application/json',
        ),
