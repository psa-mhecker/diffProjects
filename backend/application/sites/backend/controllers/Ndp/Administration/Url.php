<?php
class Ndp_Administration_Url_Controller extends Pelican_Controller_Back
{
    ...
    public function listAction()
    {
        ...
        $table->addTextarea('REWRITE_URL', array('_onchange' => $cmd, "class" => "rewrite_box"), "", "", "tblheader", 0, 1, 1, t('REDIRECTIONS'));
...
<script type=\"text/javascript\">
    function verifUrl(obj) {
        ...
        $this->aButton["back"] = ""; //hide back button
        $this->aButton["add"] = ""; //hide add button
        $this->aButton['save'] = ""; //hide save button
