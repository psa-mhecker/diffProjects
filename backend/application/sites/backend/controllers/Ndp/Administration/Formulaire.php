 ...
 *
 * @author Pierr Pottié <pierre.pottie@businessdecision.com>
 *
 * @since 20/07/2015
 */
require_once Pelican::$config['APPLICATION_CONTROLLERS'].'/Ndp.php';
class Ndp_Administration_Formulaire_Controller extends Ndp_Controller
{
...
SQL;
    ...
    public function editAction()
    {
        ...
        try{
           $service = Pelican_Application::getContainer()->get('bo_forms');
            ...
            $sForm .= $this->oForm->createComboFromList('FORM_INCE_CODE', t('FORM_INCE_CODE'),$values,$this->values["FORM_INCE_CODE"],true);
        } catch(Exception $e){
            $sForm .=$this->oForm->createDescription('webservice Forms :'.$e->getMessage());
    ...
    public function saveAction()
    {
        ...
        Pelican_Cache::clean("Frontend/Ndp/FormType");
        Pelican_Cache::clean("Frontend/Ndp/Formulaire");
    }
