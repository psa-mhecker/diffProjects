...
class Cms_Page_Citroen_PointsDeVente extends Cms_Page_Citroen
{
    public static function render(Pelican_Controller $controller)
    {
        ...
        if ($controller->zoneValues['TEMPLATE_PAGE_ID'] ==  Pelican::$config['TEMPLATE_PAGE']['GLOBAL']) {
            ...
            $return .= $controller->oForm->createRadioFromList($controller->multi."ZONE_TITRE6", t('HIGHLIGHT_CONCESSIONS'), array('1' => t("OUI"), '2' => t("NON")), ($controller->zoneValues['PAGE_ID'] == -2 || empty($controller->zoneValues['ZONE_TITRE6'])) ? '1' : $controller->zoneValues['ZONE_TITRE6'], false, $controller->readO);
        }
