...
class Cms_Page_Citroen_Home_Offres extends Cms_Page_Citroen
{
    public static function render(Pelican_Controller $controller)
    {
        ...
        $return = $controller->oForm->createContentFromList($controller->multi."ZONE_PARAMETERS", "Contenus", $value, false, $controller->readO, "10", 300, false, false, "9", true);
