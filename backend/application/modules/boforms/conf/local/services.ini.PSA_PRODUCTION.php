...
\Itkg::$config['AC_SERVICE_BOFORMS']['PARAMETERS'] = array(
		'location' => 'http://sgp.wssoap.inetpsa.com/dcr/ac/services/BOFormService',
		'http_auth_login' => 'mdecpw00',     
		'http_auth_password' => 'svncpw00',
		'wsdl_cache' => 0,
		'timeout' => 10,
		'wsdl' => 'http://sgp.wssoap.inetpsa.com/dcr/ac/services/BOFormService?wsdl'
);
/***/
...
\Itkg::$config['CITROEN_SERVICE_I18N']['PARAMETERS'] = array(
		'location' => 'http://dp-dcr.citroen.inetpsa.com/boforms',
		/*'login' => 'CFG',
		'password' => 'recette',*/
		'wsdl_cache' => 0,
		'timeout' => 10,
		'wsdl' => 'http://dp-dcr.citroen.inetpsa.com/boforms?wsdl'
...
Pelican::$config['BOFORMS_FORM_XSD'] = 'http://dp-dcr.citroen.inetpsa.com/dcr/form/form.xsd';