...
Pelican::$config['BOFORMS_URL_CLEARCACHE'] = "http://dp-dcr.citroen.preprod.inetpsa.com";
...
//Pelican::$config['PROXY']['URL'] = 'http://relaishttp.sgppsa.inetpsa.com:80';

Pelican::$config['AC_PROXY'] = array(
		'URL' => 'http://http.internetpsa.inetpsa.com:80',
		'LOGIN' => 'mdecpw00',
		'PWD' => 'svncpw00',
