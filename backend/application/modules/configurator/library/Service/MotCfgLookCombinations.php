 ...
 *
 */
class Plugin_MotCfgLookCombinations extends Service
{
    /**
     * Client SOAP.
     */
     ...
     *
     */
    public function lookCombinations($requestModel, $responseClass, $mapping, $test = false)
    {
        $serviceWS = 'lookCombinations';
        try {
            ...
            if ($responseModel->LookCombinationsResponse->Versions) {
                return $responseModel->LookCombinationsResponse->Versions;
            } else {
                return false;
            }
