...
/**
 * Class Pn15EnTeteConfiShowManuelSliceConfigurator
 *
 * @package Itkg\Migration\Configurator
 */
class Pn15EnTeteConfiShowManuelSliceConfigurator extends AbstractSliceConfigurator
{
    /**
     * @return string
     */
    ...
    )
    {
        ...
        // Cannot be display in mobile
        $block->setZoneMobile(0);
