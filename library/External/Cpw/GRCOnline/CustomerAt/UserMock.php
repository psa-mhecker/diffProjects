...
class Cpw_GRCOnline_CustomerAt_UserMock
{
	...
	public function addDealer($accesstoken, Cpw_GRCOnline_CustomerAt_Dealer $dealer = null)
	{
	...
	public function deleteDealer(Cpw_GRCOnline_CustomerAt_Dealer $dealer, $accesstoken)
	{
		if ($dealer->Type == 'VN')
		{
			$this->DealerVN = array();
