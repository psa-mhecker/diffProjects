...
class Cpw_GRCOnline_CustomerAt_Vehicle
{
	...
	/**
     * Construtor of the Cpw_GRCOnline_CustomerAt_Vehicle class
     */
    ...
    {
    	if ($this->RegistrationDate != '') return $this->RegistrationDate;
    	if ($this->DeliveryDate != '') return $this->DeliveryDate;
    	if ($this->OrderDate != '') return $this->OrderDate;
