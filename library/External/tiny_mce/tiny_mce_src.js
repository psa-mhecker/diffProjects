...
(function(tinymce) {
	...
	tinymce.create('tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton', {
		...
		renderMenu : function() {
			...
			// Generate color grid
			i = 0;
      if (s.title1 != '' && s.custom == true) {
          tr = DOM.add(tb, 'tr');
          n = DOM.add(tr, 'td', {colspan: 8}, ed.translate(s.title1));
      }
      ...
      i = 0;
      if (s.title2 != '' && s.custom == true) {
          tr = DOM.add(tb, 'tr');
          n = DOM.add(tr, 'td', {colspan: 8}, ed.translate(s.title2));
      }
			each(is(s.colors2, 'array') ? s.colors2 : s.colors2.split(','), function(c) {
				c = c.replace(/^#/, '');
      ...
      i = 0;
      if (s.title3 != '' && s.custom == true) {
          tr = DOM.add(tb, 'tr');
          n = DOM.add(tr, 'td', {colspan: 8}, ed.translate(s.title3));
      }
			each(is(s.colors3, 'array') ? s.colors3 : s.colors3.split(','), function(c) {
				c = c.replace(/^#/, '');
