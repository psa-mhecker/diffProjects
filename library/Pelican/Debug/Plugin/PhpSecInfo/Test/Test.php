 ...
 */
require_once(dirname(__FILE__).'/../PhpSecInfo.php');
...
class PhpSecInfo_Test
{
    ...
    /*var $_messages = array(
                    ...
                    PHPSECINFO_TEST_RESULT_NOTICE => array(
                                                'en' => 'This could potentially be a Pelican_Security issue',
                                                ),
                    PHPSECINFO_TEST_RESULT_WARN => array(
                                                'en' => 'This setting may be a serious Pelican_Security problem',
                                                ),
     ...
     */
    public function PhpSecInfo_Test()
    {
        $this->_setMessages();
    }
    ...
    public function _setMessages()
    {
        ...
        $this->setMessageForResult(PHPSECINFO_TEST_RESULT_NOTICE,	'en', 'This could potentially be a Pelican_Security issue');
        $this->setMessageForResult(PHPSECINFO_TEST_RESULT_WARN,	'en', 'This setting may be a serious Pelican_Security problem');
