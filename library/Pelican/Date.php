...
class Pelican_Date {
    ...
    public function setDate($date, $format = 'd/m/Y') {
         ...
         * @return __TYPE__
         */
        function getPreviousMonth($format = "") {
         ...
         * @return __TYPE__
         */
        function getPreviousYear($format = "") {
            $date = $this->getYearAdd(+1);
            return $this->getDate($date, $format);
        }
         ...
         * @return __TYPE__
         */
        function getLabelDay($date, $short = false) {
