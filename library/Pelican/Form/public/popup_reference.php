...
<br />
	<?php
		if (!empty($strError) ) {
		?>
<font color="#ff0000"><? echo $strError ?></font><br /><br />
		<?php
		}
	?>
...
<tr>
	<td colspan="2" align="center"><? $oForm->createSubmit("Save", t('POPUP_BUTTON_SAVE')); ?>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<? $oForm->createButton("Close", t('POPUP_BUTTON_CLOSE'), "close"); ?></td>
</tr>
	<?php
		$oForm->close();
				...
				<body id="body_popup">
					<div align="center">
						...
						<table width="300" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
									<td colspan="2" align="center"><? $oForm->createSubmit("Delete", t('POPUP_LABEL_DEL')); ?>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<? $oForm->createButton("Close", t('POPUP_BUTTON_CLOSE'), "close"); ?></td>
							</tr>
							<?php
...
?>
						<table width="300" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
									<td colspan="2" align="center"><? $oForm->createSubmit("Update", t('POPUP_BUTTON_OK')); ?>
								&nbsp;&nbsp;&nbsp;&nbsp;
								<? $oForm->createButton("Close", t('POPUP_BUTTON_CLOSE'), "close"); ?></td>
							</tr>
							<?php
