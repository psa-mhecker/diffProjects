function popupMediaHmvc(strType, strPath, Field, Div, strGroup, UPLOAD_HTTP,
		UPLOAD_PATH, bLibrary) {
	var arr = "";
	var args = new Object;
	var strParam = "";
	var arr;
...
function popupInternalLinkHmvc(obj) {
	...
	args["page"] = "";
	var arr = showModalDialog(
			"/_/Popup/internalLink?LANGUE_ID="+document.getElementById("LANGUE_ID").value,
			args,
