...
/*function initSuggest(id)
{
	if (typeof _noSearchFocus == 'undefined')
        document.forms.search_form[id].focus();
    if (msIE && ua.charAt(30) == 5) {
        document.write('<style type="text/css"><!--\nbody, table {font-size: x-small;}\n--></style>');
        for(var i = 0; i < document.getElementsByTagName('table').length; i++)
        document.getElementsByTagName('table')[i].style.width = document.getElementsByTagName('table')[i].offsetWidth-135 + 'px';
    }
}*/
