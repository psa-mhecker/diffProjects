 ...
 */
//REPRIS DE ZEND_FORM_ELEMENT_MULTI/SELECT
Class Pelican_Form_Element_Select extends Pelican_Form_Element_Xhtml {
   /**
	...
	/**
	 * Utilisation du helper formSelect par default
	 *
	 * @var string
	 */
