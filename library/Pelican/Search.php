...
class Pelican_Search {
     ...
     */
    function Pelican_Search($research_type = "Lucene") {
     ...
     * @return __TYPE__
     */
    function indexationInit($id, $site, $langue, $research_type, $research_type_id, $date) {
     ...
     * @return __TYPE__
     */
    function addValue($key, $value, $allowEmpty = false) {
     ...
     * @return __TYPE__
     */
    function getStatistics($site, $langue, $fields, $filters) {
     ...
     * @return __TYPE__
     */
    function addDateValue($key, $aValues, $default) {
     ...
     * @return __TYPE__
     */
    function getContentFromXml($file) {
        if (file_exists($file)) {
     ...
     * @return __TYPE__
     */
    function getContentFromSql($sSQL) {
        $oConnection = Pelican_Db::getInstance();
     ...
     * @return __TYPE__
     */
    function logResearch($site, $word) {
        $oConnection = Pelican_Db::getInstance();
