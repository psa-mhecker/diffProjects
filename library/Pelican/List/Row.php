...
class Pelican_List_Row {
     ...
     */
    function Pelican_List_Row($header, $field, $width = "", $align = "", $format = "", $class = "", $order = "", $type = "text", $attributes = "", $aShow = "", $sum = false, $tooltip = "", $iColSpan = 1, $iRowSpan = 1, $iNum = "", $onClick = "") {
