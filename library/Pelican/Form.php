...
class Pelican_Form {
    ...
    public function getDisposition() {
         ...
         *
         * @access public
         * @param string $strString __DESC__
         * @return __TYPE__
         */
         ...
         *
         * @access public
         * @param string $aData (option) __DESC__
         * @return __TYPE__
         */
        ...
        public function createInput($strName, $strLib, $iMaxLength = "255", $strControl = "", $bRequired = false, $strValue = "", $bReadOnly = false, $iSize = "10", $bFormOnly = false, $strEvent = "", $strType = "text", $aSuggest = array(), $multiple = false) {
            ...
            if ($bReadOnly) {
                ...
                if (!$bFormOnly && $strValue) {
                     ...
                     * @param string $iSiteId (option) __DESC__
                     * @return void
                     */
                     ...
                     * @return void
                     */
                    public function _getValuesFromSQL($deprecated, $strSQL, &$aDataValues, $aBind = array()) {
                        $oConnection = Pelican_Db::getInstance();
                     ...
                     * @param string $iID (option) __DESC__
                     * @param mixed $aCheckedValues (option) Liste des valeurs cochées (liste des id)
                     * : "" par défaut
                     * @param bool $bRequired (option) Champ obligatoire : false par défaut
                     * @param bool $bReadOnly (option) Affiche uniquement la valeur et pas le champ
                     ...
                     * @param bool $bFormOnly (option) __DESC__
                     * @param string $strEvent (option) __DESC__
                     * @param string $strColRefTableName (option) __DESC__
                     * @return string
                     */
                    ...
                    public function _createCombo($strName, $strLib, $aDataValues, $aSelectedValues, $bRequired, $bReadOnly, $iSize, $bMultiple, $iWidth, $bChoisissez, $bEnableManagement = false, $bFormOnly = false, $strTableName = "", $strEvent = "", $sSearchQueryName = "", $bDelManagement = false, $bUpdManagement = false) {
                        ...
                        // Génération de la fonction js de vérification.
                        if (!$bReadOnly && $bRequired) {
                            if ($bMultiple) $this->_sJS.= "var o = obj.elements[\"" . $strName . "[]\"];\n";
                            else $this->_sJS.= "var o = obj." . $strName . ";\n";
                    ...
                    public function createCombo($oConnection, $strName, $strLib, $strTableName, $strRefTableName = "", $iID = 0, $aSelectedValues = "", $bRequired = false, $bReadOnly = false, $iSize = "1", $bMultiple = false, $iWidth = "", $bChoisissez = true, $bEnableManagement = false, $bFormOnly = false, $strEvent = "") {
                        ...
                        if ($aSelectedValues == "") $aSelectedValues = $aTmpSelectedValues;
				...
				ORDER BY lib";
                    ...
                    public function _createAssoc($oConnection, $strName, $strLib, $aDataValues, $strTableName, $strRefTableName = "", $iID = "", $aSelectedValues = "", $bRequired = false, $bDeleteOnAdd = true, $bEnableManagement = true, $bSearchEnabled = false, $bReadOnly = false, $iSize = "5", $iWidth = 200, $strColRefTableName = "contenu_id", $bFormOnly = false, $arForeignKey = "", $bSingle = false, $alternateId = false, $strOrderColName = '', $showAll = false, $limit = 0) {
                        global $HTTP_SESSION_VARS;
                        $strTmp = "";
                        if (!$bReadOnly) $this->_aIncludes["list"] = true;
                        if ($bSearchEnabled) {
                     ...
                     * false par défaut
                     * @param string $siteExterne (option) __DESC__
                     * @return string
                     */
                     ...
                     *
                     * @access public
                     * @param string $fieldName (option) __DESC__
                     * @param bool $activation (option) __DESC__
                     * @return __TYPE__
                     */
                    ...
                    public function createEditor($strName, $strLib, $bRequired = false, $strValue = "", $bReadOnly = false, $bPopup = true, $strSubFolder = "", $Width = "", $Height = "", $limitedConf = "") {
                        ...
                        if ($bRequired && !$bReadOnly) $strTmp.= $this->_sRequiredIndicator;
                        if (!$bReadOnly) {
                     ...
                     * @param bool $bToggle (option) __DESC__
                     * @param string $strLib2 (option) __DESC__
                     * @return string
                     */
                    ...
                    public function createButton($strName, $strLib = "", $strFunction = "", $bDisable = false) {
                        ...
                        $strTmp.= " onclick=\"";
                        if ($strFunction == "close") $strTmp.= "javascript:self.close();";
                        else $strTmp.= $strFunction;
                        $strTmp.= "\" ";
                        if ($bDisable) {
                            $strTmp.= " disabled";
                        }
                    ...
                    public function createReset($strName, $strLib = "") {
                        ...
                        if ($strLib != "") $strTmp.= " value=\"" . Pelican_Text::htmlentities($strLib) . "\"";
                        $strTmp.= " />";
                        return $this->output($strTmp);
                    }
                    ...
                    public function createSubmit($strName, $strLib = "", $strImage = "", $iWidth = "", $iHeight = "", $bDisable = false, $strEvent = "") {
                        ...
                        if ($strImage != "") {
                            ...
                            if ($iWidth != "") $strTmp.= "width=\"" . $iWidth . "\"";
                            if ($iHeight != "") $strTmp.= "height=\"" . $iHeight . "\"";
                            $strTmp.= "border=\"0\"";
                        } else {
                    ...
                    public function createTextArea($strName, $strLib, $bRequired = false, $strValue = "", $iMaxLength = "", $bReadOnly = false, $iRows = 5, $iCols = 30, $bFormOnly = false, $wrap = "", $bcountchars = true, $strEvent = "") {
                        ...
                        if ($bReadOnly) {
                            ...
                            if (!$this->_sDefaultFocus) $this->_sDefaultFocus = $strName;
                            if ($wrap) {
                                $txtWrap = ' wrap="' . $wrap . '"';
                            } else {
                                $txtWrap = '';
                     ...
                     * @param bool $bRadio (option) __DESC__
                     * @param bool $bReadOnly (option) Affiche uniquement la valeur et pas le champ
                     * (créé un input hidden) : false par défaut
                     * @param bool $bFormOnly (option) Génération du champ uniquement, sans libellé
                     * : false par défaut
                    ...
                    public function createTabCroiseGenerique($oConnection, $strName, $strLib, $strQueryColumn, $strQueryRow, $strQueryData, $iFilterID = "", $strFilterColumn = "", $bHelpButtons = true, $bRadio = false, $bReadOnly = false, $bFormOnly = false) {
                        ...
                        if ($bReadOnly) {
                            ...
                            if (!is_array($aFiltre)) $aFiltre = array();
                        }
                        if ($bHelpButtons) {
                        ...
                        if (!is_array($strQueryData)) {
                            if (strlen($strQueryData) != 0) {
                                // Lecture des données
                                $strSQL = $strQueryData;
                                if (($strFilterColumn != "") && ($iFilterID != "")) $strSQL.= " AND " . $strFilterColumn . " = " . $iFilterID;
                                $oConnection->Query($strSQL);
                                $aData = array();
                                if ($oConnection->rows != 0) {
                        ...
                        $strTmp.= $strFiltre;
                        if ($bHelpButtons && !$bRadio) $strTmp.= strtr($strBoutons, array("%%COL%%" => "", "%%ROW%%" => ""));
                        ...
                        foreach($aAbscisses as $key => $value) {
                            ...
                            if ($bHelpButtons) $strTmp2.= "<td align=\"center\" class=\"croiselib\">" . strtr($strBoutons, array("%%COL%%" => $key, "%%ROW%%" => "")) . "</td>";
                        ...
                        if ($aOrdonnees) {
                            foreach($aOrdonnees as $iY => $strLibY) {
                                ...
                                if ($bHelpButtons && !$bRadio) $strTmp.= "<td align=\"center\"  class=\"croiselib\">" . strtr($strBoutons, array("%%COL%%" => "", "%%ROW%%" => $iY)) . "</td>";
                                reset($aAbscisses);
                     ...
                     * @param string $colspan (option) __DESC__
                     * @return string
                     */
                    ...
                    public function createMulti($oConnection, $strName, $strLib, $fileName, $tabValues, $incrementField, $bReadOnly = false, $intMaxIterations = "", $bAllowDeletion = true, $bAllowAdd = true, $strPrefixe = "multi", $line = "values", $strCss = "multi", $sColspan = "2", $sButtonAddMulti = "", $complement = "") {
                        ...
                        $this->countInputName($strName);
                        $strTmp.= "<iframe src=\"/library/blank.html\" name=\"iframe_" . $strName . "\" id=\"iframe_" . $strName . "\" width=\"0\" height=\"0\" marginwidth=\"0\" marginheight=\"0\" scrolling=\"no\" frameborder=\"0\"></iframe>";
                        $strTmp.= "</td></tr>\n";
                     ...
                     * @param string $strLib __DESC__
                     * @param __TYPE__ $call __DESC__
                     * @param string $tabValues (option) __DESC__
                     * @param bool $bReadOnly (option) __DESC__
                     * @param bool $bFormOnly (option) __DESC__
                     * @param string $strJsVar (option) __DESC__
                     * @param string $strCss (option) __DESC__
                     * @return __TYPE__
                     */
                    ...
                    public function close($_sJSPath = "") {
                        ...
                        $strTmp = $this->putHidden();
                        $this->endJS = '';
                        if (!$_sJSPath) $_sJSPath = $this->_sLibPath . $this->_sLibForm . "/js/";
                        $strTmp.= "</form>\n";
                        /***** init de tinyMCE ***************/
...
";
                         ...
                         *
                         * @access public
                         * @param __TYPE__ $sValue __DESC__
                         * @param bool $bRequired (option) __DESC__
                         * @param bool $bReadOnly (option) __DESC__
                         * @return __TYPE__
                         */
                         ...
                         * @param string $typeId (option) __DESC__
		...
		if (tinyMCE.get(editor_id))
			tinyMCE.get(editor_id).show();
                    ...
                    */
                     ...
                     * @param bool $closed (option) __DESC__
                     * @param bool $setCookie (option) __DESC__
                     * @param bool $bDirectOutput (option) __DESC__
                     * @return void
                     */
