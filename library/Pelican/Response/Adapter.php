...
class Pelican_Response_Adapter
{
    ...
    {
        /*
        include_once(Pelican::$config['LIB_ROOT'] . Pelican::$config['LIB_OTHER'] . '/percentmobile/percent_mobile.php');

        ob_start();
        percent_mobile_track('290132363521866302435893097284614784468');
        $tracker = ob_get_contents();
        ob_clean();
