function initMenu() {
	...
	var menu = document.getElementById('tablet_menu');
...
function drawMenuBackground(rectWidth, rectHeight) {
	...
	var context = document.getCSSCanvasContext('2d', 'menu_background',
	...
	var gradient = context.createLinearGradient(rectWidth / 2, 0,
			rectWidth / 2, arrowHeight * 2);
