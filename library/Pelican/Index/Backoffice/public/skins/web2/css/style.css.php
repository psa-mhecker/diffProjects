...
$aDiv['div_header']['left'] = 5;
$aDiv['div_header']['width'] = $window_width-$main_margin;
...
$aDiv['div_onglet']['top'] = $aDiv['div_header']['height']+25;
$aDiv['div_onglet']['left'] = 10;
$aDiv['div_onglet']['width'] = $aDiv['div_main']['width']-20;
...
$aDiv['frame_left_top']['top'] = $main_margin+10;
$aDiv['frame_left_top']['left'] = $main_margin-4;
$aDiv['frame_left_top']['width'] = 200;
$aDiv['frame_left_top']['height'] = 50;

$aDiv['frame_left_middle']['top'] = $aDiv['frame_left_top']['top']+$aDiv['frame_left_top']['height'];
$aDiv['frame_left_middle']['left'] = 1+$main_margin;//$aDiv['frame_left_top']['left'];
$aDiv['frame_left_middle']['width'] = $aDiv['frame_left_top']['width']-2;
$aDiv['frame_left_middle']['height'] = $aDiv['div_content']['height']-$aDiv['frame_left_top']['height']-6*$main_margin-$bouton_height-3*$firefox;
...
$aDiv['frame_right_top']['left'] = $aDiv['frame_left_top']['left']+$aDiv['frame_left_top']['width']+2*$main_margin;
$aDiv['frame_right_top']['width'] = $aDiv['div_content']['width']-4*$main_margin-$aDiv['frame_left_top']['width']+6;
$aDiv['frame_right_top']['height'] = $aDiv['frame_left_top']['height'];

$aDiv['frame_right_middle']['top'] = $aDiv['frame_left_middle']['top'];
$aDiv['frame_right_middle']['left'] = $aDiv['frame_right_top']['left']+5;
$aDiv['frame_right_middle']['width'] = $aDiv['frame_right_top']['width']-2;
...
$aDiv['frame_right_bottom']['width'] = $aDiv['frame_right_top']['width']+$main_margin;
