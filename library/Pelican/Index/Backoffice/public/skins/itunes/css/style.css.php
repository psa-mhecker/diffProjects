...
#divrubrique1, #divmedia1 { background-image: url(/library/Pelican/Index/Backoffice/public/skins/itunes/images/fond.gif); height: <?=($aDiv ['frame_left_middle'] ['height'] - 40)?>px; padding: 5px 5px 5px 5px; }