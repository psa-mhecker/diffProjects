...
class HTTP_ConditionalGet {
     ...
     * "public", allowing proxies to Pelican_Cache the content. Otherwise "private" will 
     ...
     * 
     * 'invalidate': (bool) if true, the client Pelican_Cache will be considered invalid
    ...
    public function __construct($spec)
    {
        ...
        // invalidate Pelican_Cache if disabled, otherwise check
    ...
    /**
     * Exit if the client's Pelican_Cache is valid for this resource
     *
     ...
     * will contain "public", allowing proxies to Pelican_Cache the content. Otherwise 
    ...
    /**
     * Determine validity of client Pelican_Cache and queue 304 header if valid
     */
